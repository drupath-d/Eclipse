...
public class Copypaste
{
   ...
   public void test()
   {
	   WebElement fullname=driver.findElement(By.xpath("//td[@width=\"200\"]/input[1]"));
	   WebElement rediffid=driver.findElement(By.xpath("//td[@valign=\"bottom\"]/input[1]"));
	   fullname.sendKeys("Jojo");
